    ...
    <page>
        ...
        <div class="tableList">
            ...
            >
                ...
                <el-table-column label="公司名称" prop="companyName" header-align="center" align="center"></el-table-column>
                <el-table-column label="公司类型" prop="companyTypeName" header-align="center" align="center"></el-table-column>
        ...
        methods:{
            ...
            exportExcel(){
                this.API.exportReportList({
                    ...
                    link.href = url;
                    link.setAttribute('download', '设计装修公司入驻信息导出.xls')
