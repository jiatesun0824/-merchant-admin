<template>
    <page>
        ...
        <div class="searchNav">
            ...
            <div class="search-item">
                <el-input v-model="params.mobile" filter placeholder="手机号码" clearable></el-input>
            </div>
        </div>
        ...
        <div class="tableList">
            ...
            >
                ...
                <el-table-column label="类型" prop="businessTypeName" header-align="center" align="center">
                    <template slot-scope="scope">
                        <span v-if="scope.row.type==0">0元设计</span>
                        <span v-else-if="scope.row.type==1">装修报价</span>
                        <span v-else-if="scope.row.type==3">店铺预约</span>
                    </template>
                </el-table-column>
                ...
                <el-table-column label="渠道" prop="utmSource" header-align="center" align="center"></el-table-column>
                <el-table-column label="计划" prop="utmCampaign" header-align="center" align="center"></el-table-column>
                <el-table-column label="小组" prop="utmAdgroup" header-align="center" align="center"></el-table-column>
                <el-table-column label="关键字" prop="utmTerm" header-align="center" align="center"></el-table-column>
                <el-table-column label="城市" prop="cityName" header-align="center" align="center"></el-table-column>
                <el-table-column label="小区名称" prop="areaName" header-align="center" align="center"></el-table-column>
                <el-table-column label="房屋面积" prop="houseAcreage" header-align="center" align="center"></el-table-column>
                <el-table-column label="户型" prop="houseType" header-align="center" align="center"></el-table-column>
