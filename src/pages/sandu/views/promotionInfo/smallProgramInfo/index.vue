    ...
    <page>
        ...
        <div class="tableList">
            ...
            >
                ...
                <el-table-column label="行业" prop="trade" header-align="center" align="center"></el-table-column>
                ...
                <el-table-column label="录入时间" prop="gmtCreated" header-align="center" align="center"></el-table-column>
                <el-table-column label="更改时间" prop="gmtModified" header-align="center" align="center"></el-table-column>
        ...
        methods:{
            ...
            exportExcel(){
                this.API.exportReportList({
                    ...
                    link.href = url;
                    link.setAttribute('download', '小程序意向企业/经销商信息导出.xls')
