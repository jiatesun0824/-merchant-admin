...
<div id="activity">
    <div class="mains">
        ...
        <div class="mainBody">
            ...
            <div class="dataTable">
                <div class="listTitle" style="color: red;text-align: left; font-size: 12px" >*&nbsp;  名片：从电子名片入口登录的用户&nbsp;&nbsp;&nbsp;  其他：非电子名片入口登录的用户</div>
    ...
    export default {
        ...
        methods: {
            ...
            getList(){
                ...
                if (!flag){
                    this.API.getSourceAnalysisList2({
                        appId:this.appId,
            ...
            getExcel(){
                let flag=this.checkAppId(this.appId);
                if (!flag){
                    this.API.getSourceAnalysisSum2({
                        appId:this.appId,
                        dateType:this.radios
                    }).then((res)=>{
                        if(res.success){
