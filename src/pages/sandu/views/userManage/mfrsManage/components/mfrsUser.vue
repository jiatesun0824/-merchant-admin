<template>
    <div class="main">
        ...
        <userList   @handleSelectionChange="handleSelectionChange" @showBatch="showBatch" :userdata="userListData" :page="page" :businessType='businessType' :loading="loading" @refresh="getlist('vendor',$route.query.id)" @pageChange="pageChange" @sizeChange="sizeChange" @pageReset="pageReset"></userList>
