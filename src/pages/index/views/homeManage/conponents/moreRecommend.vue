<template>
    <transition name="zoomIn">
        <div class="recommend">
            <div class="recommend-header">标题模块<span>（*必填项）</span></div>
            <div class="recommend-content">
                ...
                <div class="recommend-goods">
                    ...
                    <ul>
                        <li v-for="(item,index) in submitMoreGoodsList" :key="index" v-dragging="{ item: item, list: submitMoreGoodsList, group: 'morefile' }">
                        ...
                        <li @click="addGoods" v-if="submitMoreGoodsList.length<10">+ 添加商品</li>
                    </ul>
                </div>
            </div>
            <div class="bottom">
...
<script>
    ...
    export default {
        ...
        computed:{
            ...mapState('homeManage',['addGoodsDialog','submitMoreGoodsList','titleList','moduleTitle'])
        },
        methods:{
            ...mapActions('homeManage',['dialog','setSubmitMoreGoodsList','setReplace','setSave','setModuleTitle']),
            changeInput(e){
            ...
            deleteGoodslist(item){
                this.setSubmitMoreGoodsList({res:item,type:0});//从新的数组里删除 0删除
            },
