<template>
    <transition name="zoomIn">
        <div class="recommendPlan">
            <div class="recommend-header">热门方案<span>（*必填项）</span></div>
            <div class="recommend-content">
                <div class="recommend-title">
                    <span><em>*</em>标题：</span>
                    <input type="text" maxlength="8" :value="moduleTitle" @input="changeInput" class="recommend-input">
                    <span class="recommend-tip">不超过8个字，4个字为最佳展示效果</span>
                </div>
                <div class="recommend-goods">
                    <div class="recommend-goods-text"><span><em></em></span> <span>方案数最多不超过10个，拖动选中的图片可对其排序</span></div>
                    <ul>
                        <li v-for="(item,index) in submitPlansList" :key="index" v-dragging="{ item: item, list: submitPlansList, group: 'planfile' }">
                        ...
                        <li @click="addGoods" v-if="submitPlansList.length<10">+ 添加方案</li>
                    </ul>
                </div>
            </div>
            <div class="bottom">
...
<script>
    ...
    export default {
        ...
        computed:{
            ...mapState('homeManage',['submitPlansList','moduleTitle']),
        },
        methods:{
            ...mapActions('homeManage',['planDialog','setSubmitPlansList','setReplace','setSave','setModuleTitle']),
            changeInput(e){
