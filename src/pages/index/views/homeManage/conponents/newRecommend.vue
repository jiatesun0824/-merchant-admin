<template>
    <transition name="zoomIn">
        <div class="recommend">
            <div class="recommend-header">新品推荐<span>（*必填项）</span></div>
            <div class="recommend-content">
                ...
                <div class="recommend-goods">
                    ...
                    <ul>
                        <li v-for="(item,index) in submitNewGoodsList" :key="index" v-dragging="{ item: item, list: submitNewGoodsList, group: 'file' }">
                        ...
                        <li @click="addGoods" v-if="submitNewGoodsList.length<10">+ 添加商品</li>
                    </ul>
                </div>
            </div>
            <div class="bottom">
...
<script>
    ...
    export default {
        ...
        computed:{
            ...mapState('homeManage',['addGoodsDialog','submitNewGoodsList','moduleTitle'])
        },
        methods:{
            ...mapActions('homeManage',['dialog','setSubmitNewGoodsList','setReplace','setSave','setModuleTitle']),
            changeInput(e){
            ...
            deleteGoodslist(item){
                this.setSubmitNewGoodsList({res:item,type:0});//从新的数组里删除 0删除
            },
