    ...
    export default {
        ...
        data() {
            return {
                ...
                //列表查询入参
                queryList: {
                    dateType:'',//时间类型(昨天、今天、7日、30日、每月)
                    userType:'',//用户类型(0:新增用户,1:活跃用户)
                    miniName: '', // 企业小程序名称
                    start: 1, // 页码
                    limit: 10 // 每页条数
                },
        ...
        methods: {
            ...
            getExcel(){
                this.API.getAreaUserAnalysisList(
                    {
                    ...
                    if(res.success){
                        ...
                        if (this.areaTop10.length>0){
                            for (var i = 0;i<this.areaTop10.length;i++) {
                                ...
                                if (this.userType===0) {
                                    console.log("ddddddddd"+this.areaTop10[i].activeUserCount)
            ...
            dataChange(dataType){
                ...
                this.queryList.dateType=dataType;
