    ...
    <div class="batchAdd">
        <el-dialog width="540px"
            ...
            <div class="batchAddInfo">
                 <div class="batch-text">线下门店导入：</div>
    ...
    export default {
        ...
        data(){
            return{
                ...
                upLoadUrl:process.env.baseUrl+'/v1/companyshopoffline/import',
                batchAdd:false,
                fileName:'',
                file:'',
                sw:0
        ...
        methods:{
            ...
            confirm(){
                if(this.file){
                    ...
                    this.$store.dispatch('fileLoadingDialog',{ isshow:true,vm:this,tip:'批量导入线下门店成功,请手动刷新!'});
                    if(this.sw==0){
                        this.sw=1;
                        let formdata=new FormData();
                        formdata.append('filename',this.fileName);
                        formdata.append('file',this.file);
                        this.API.shopImport(formdata).then(res=>{
                            this.sw=0;
            ...
            download(){
                window.location=process.env.sourceBaseUrl+'/shopTemplate.xlsx';
            }
        }
    }
</script>
