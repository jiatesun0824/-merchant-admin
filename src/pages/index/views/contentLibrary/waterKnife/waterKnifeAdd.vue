                    ...
                    <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
                        ...
                        <el-form-item label="CAD源文件：" class="logo">
                            ...
                            <el-upload
                                ...
                                <span v-if="fileShow">{{fileShow}}</span>
                            </el-upload>
                            <p class="img-text">文件格式支持：DXF</p>
                        </el-form-item>
        ...
        methods: {
            ...
            fileSuccess(res, file) {
                if (res.success) {
                    ...
                    console.log(this.ruleForm.cadSourceFileId,"this.ruleForm.cadSourceFileId")
                } else {
                    this.$message({
                        type: "error",
                        message: res.message
                ...
                this.$refs[formName].validate((valid) => {
                    if (valid) {
                        ...
                        this.$confirm('确定新增水刀模板?', '提示', {
                            ...
                            this.API.addWaterKnifeList(this.ruleForm).then((res) => {
                                if(res.success){
            ...
            resetForm(formName) {
                ...
                this.$message({ message: "您取消了此次新增", type: "warning" });
                this.$router.push("/content/waterKnife");
            }
        }
    }
