      ...
      <div>
        ...
        <div class="planList">
          ...
          >
            ...
            <el-table-column type="selection" label="全选" align="left" width="30" title="全选"></el-table-column>
            <el-table-column prop="planCode" label="编号" sortable width="150"></el-table-column>
            ...
            <el-table-column prop="origin" width="100" align="center" label="来源">
              <template slot-scope="scope">
            ...
            <el-table-column prop="containsSecrecyFlag" label="包含非公开产品" width="100">
              <template slot-scope="scope">
            ...
            <el-table-column prop="salePrice" label="方案价格" width="110">
              <template slot-scope="scope">
                <div>
                  <p>售卖价格:{{scope.row.salePriceChargeType == 1 ? scope.row.salePrice : '免费'}}</p>
                </div>
                <div>
                  <p>版权费:{{scope.row.chargeType == 1 ? scope.row.planPrice : '免费'}}</p>
                </div>
              </template>
            </el-table-column>
