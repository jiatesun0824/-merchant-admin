  ...
  <div>
    ...
    <div class="planList">
      ...
      >
        ...
        <el-table-column prop="operation" label="操作" align="center" width="200" v-if="!isRadio">
          <template slot-scope="scope">
            <el-button
              type="text"
              class="operatonBtn"
            ...
            <!-- <el-button class="operatonBtn" size="mini" style="padding:7px 0; text-align: center"
