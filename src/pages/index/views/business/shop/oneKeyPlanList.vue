<template>
  <div>
    <el-row :gutter="24" class="searchCondition">
      <div style="height: 115px">
        ...
        <el-col :span="3">
          ...
          <!--</el-select>-->
          <!--
                    Modified by songjianming@sanduspace.cn on 2019/01/04
                    凉凉~~~~上面的代码是那个S13写的~~~~~
          -->
    ...
    <!--<el-dialog
        ...
        <el-button round type="primary" @click="handleShelfConfirm" style="width: 80px" class="confirmButtonClass">确 定</el-button>
        <el-button round type="info" @click="shelfDialogVisible = false"  style="width: 80px"  class="cancelButtonClass">取 消</el-button>
      </span>
    </el-dialog>-->
...
export default {
  ...
  created() {
    if (this.isRadio) this.query.isPublish = 1;
    this.page();
